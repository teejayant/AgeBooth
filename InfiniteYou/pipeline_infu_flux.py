...
from .pipeline_flux_infusenet import FluxInfuseNetPipeline, FluxInfuseNetInterpPipeline
...
class InfUFluxPipeline:
    def __init__(
        ...
        try:
            ...
            # )
            pipe = FluxInfuseNetInterpPipeline.from_pretrained(
                base_model_path,
                transformer=transformer,
                text_encoder_2=text_encoder_2,
                controlnet=self.infusenet,
        ...
        self.app_640 = FaceAnalysis(name='antelopev2', 
                                root=insightface_root_path, providers=['CUDAExecutionProvider', 'CPUExecutionProvider'], sess_options=sess_options)
